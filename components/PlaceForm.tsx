      ...
      <div style={{ marginTop: 10 }}>
        ...
        {!!house?.template && (
          ...
          >
            ...
            <div className="subtitle" style={{ marginBottom: 8 }}>{house.summary || "已生成房子方案"}</div>
              ...
              {Object.entries(house.palette ?? {}).map(([key, value]) =>
                typeof value === "string" ? (
                  ...
                  >
                    ...
                    />
                    <span className="subtitle">{key === "primary" ? "主色" : key === "secondary" ? "辅色" : "强调色"}</span>
                  </div>
                ) : null
              )}
            </div>
            <div className="subtitle">
              材质：{house.facade || "未生成"} · 屋顶：{house.roof || "未生成"} · 灯光：{lightingLabel(house.lighting)}
            </div>
